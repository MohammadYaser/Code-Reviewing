...
# 📖 Code-Reviewing <a name="about-project"></a>

**Code-Reviewing** is a vanilla-css project for learning web development.
...
```sh
  git clone https://github.com/MohammadYaser/Code-Reviewing
```
...
Feel free to check the [issues page](https://github.com/MohammadYaser/Code-Reviewing/issues).
...
The purpose of this project is to test that how to give a code Review to others 
